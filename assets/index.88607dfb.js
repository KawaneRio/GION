...
`,N=g(U)`
	...
	${h.lessThan("large")`
		bottom: ${"64px"};
	`}
`,z=e=>"left"===e.direction?f.createElement(N,{direction:"left",onClick:e.onClick},"<"):"right"===e.direction?f.createElement(N,{direction:"right",onClick:e.onClick},">"):f.createElement(f.Fragment,null),G=g(U)`
    position: absolute;
    display: flex;
...
`,_=g.p`
    ...
    ${h.lessThan("large")`
        display: none;
    `}
`,A=e=>f.createElement(G,{onClick:()=>window.open(e.link)},f.createElement(R,null,f.createElement(T,null,e.category)),f.createElement(q,null,e.iconPath&&f.createElement(L,{src:e.iconPath}),f.createElement(F,null,f.createElement(W,null,e.title),f.createElement(_,null,e.description)))),D=e=>f.createElement(A,{category:"GION Implicate",link:e.link,title:e.cause,description:e.content}),H=e=>f.createElement(A,{category:"GION UserMatch",iconPath:`https://unavatar.io/twitter/${e.username}`,link:`https://twitter.com/${e.username}`,title:e.username,description:e.description}),K=()=>{const e=S((e=>e)),t=e.gion[e.index].getSpecialWord();switch(null==t?void 0:t.category){case"UserMatch":return f.createElement(H,c({},t));case"Implicate":return f.createElement(D,c({},t));default:return f.createElement(f.Fragment,null)}},Q=g.div`
	display: flex;
	gap: 16px;
	flex-wrap: wrap;
	justify-content: center;
`,V=()=>{const e=x(),t=S((e=>e));return f.createElement(Q,null,f.createElement(U,{primary:!0,onClick:()=>e(P())},"再生成"),f.createElement(U,{onClick:()=>window.open(`https://twitter.com/intent/tweet?hashtags=擬音ジェネレーター&url=https://hijiki02.github.io/GION/&text=${t.gion[t.index].result}`)},"ツイートする"),f.createElement(U,{onClick:()=>window.open("https://github.com/hijiki02/GION")},"GitHub"))},B=g.div`
	color: white;
	text-align: center;
	font-size: min(10vw, 96px);
`,J=()=>{const e=S((e=>e));return f.createElement(B,null,e.gion[e.index].result)},X=b`
	0% {
...
`,Z=()=>{const e=x(),t=S((e=>e));return f.createElement(Y,null,f.createElement(f.Fragment,null,t.gion[t.index+1]&&f.createElement(z,{direction:"left",onClick:()=>e(I())}),t.gion[t.index-1]&&f.createElement(z,{direction:"right",onClick:()=>e(C())})),f.createElement(K,null),f.createElement(J,null),f.createElement(V,null))};w.render(f.createElement(y,{store:M},f.createElement(Z,null)),document.querySelector("#root"));
